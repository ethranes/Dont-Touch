...
public class Level5_5: MonoBehaviour {
	...
	public void UserSelectTrue() {		
		...
		if (currentQuestion.isTrue) {
			//PlayerPrefs.SetInt("Level6", 1);//This is set on the last scene of each level to ensure that if the player choses the correct answer it unlocks the level level, this is linked with LevelManagerNew.cs
			Debug.Log("Correct");		
			SceneManager.LoadScene("Level5.6");
		} else {
			Debug.Log("Wrong!");
